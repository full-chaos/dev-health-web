...
export const METRIC_DEFINITIONS: Record<string, MetricDefinition> = {
    cycle_time: {
        metric: "cycle_time",
        whyItMatters: "Cycle time measures the speed of your delivery pipeline. High cycle time often indicates friction in code review, testing, or deployment processes.",
        suggestedActions: [
    ...
    review_latency: {
        ...
        whyItMatters: "Review latency tracks how long code waits for feedback. Long delays here cause context switching and slow down the entire team.",
        suggestedActions: [
    ...
    throughput: {
        metric: "throughput",
        whyItMatters: "Throughput indicates the volume of value delivered. A drop in throughput might signal blocked work, technical debt, or resource constraints.",
        suggestedActions: [
    ...
    wip: {
        metric: "wip",
        whyItMatters: "Work In Progress (WIP) represents active investment. High WIP often leads to context switching and reduced throughput.",
        suggestedActions: [
    ...
    churn: {
        metric: "churn",
        whyItMatters: "Code churn (rework) can indicate unclear requirements, technical debt, or flaky tests. High churn reduces overall efficiency.",
        suggestedActions: [
    ...
    check_failure_rate: {
        ...
        whyItMatters: "High failure rates in CI/CD checks cause frustration and delays. It often points to flaky tests or brittle environments.",
        suggestedActions: [
