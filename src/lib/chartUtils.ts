 ...
 */
export const classifyValueAbsence = (value: number | null | undefined): ValueAbsence | null => {
 ...
 */
export const formatTooltipValue = (value: number | null | undefined, unit: string): string => {
