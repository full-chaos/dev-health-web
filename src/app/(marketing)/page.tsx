            ...
            <section className="mx-auto max-w-7xl px-6 pb-20 pt-16 sm:pt-24">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-(--ink-muted)">
                        ...
                        operating modes and developer health. See where effort is invested and what
            ...
            <section id="features" className="mx-auto max-w-7xl px-6 pb-24">
                <div className="text-center">
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-sm text-(--ink-muted)">
                        Every metric traces to evidence. Every insight is a hypothesis starter, not
                        a verdict. Trends over absolutes — direction matters more than point values.
                    </p>
                </div>
