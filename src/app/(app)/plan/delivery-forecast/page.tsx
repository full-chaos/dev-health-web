...
export default async function DeliveryForecastPage({ searchParams }: DeliveryForecastPageProps) {
  ...
  const forecast = await fetchOrNull(
    ...
    "plan/delivery-forecast/throughput-forecast",
  );
        ...
        <main className="flex min-w-0 flex-1 flex-col gap-8">
          <header className="flex flex-wrap items-center justify-between gap-4">
            <div>
              ...
              <h1 className="mt-2 font-(--font-display) text-3xl">Delivery Forecast</h1>
              <p className="mt-2 text-sm text-(--ink-muted)">
