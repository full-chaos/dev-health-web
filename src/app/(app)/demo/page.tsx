...
export default function Home() {
    ...
    const [workItemFlowEfficiencyDailySample, setWorkItemFlowEfficiencyDailySample] = useState<
        WorkItemFlowEfficiencyDaily[]
    >([]);
    const [workItemTypeSummarySample, setWorkItemTypeSummarySample] = useState<
        WorkItemTypeSummary[]
    >([]);
    const [workItemTypeByScopeSample, setWorkItemTypeByScopeSample] = useState<
        WorkItemTypeByScope[]
    >([]);
                    ...
                    <header className="mb-4 flex items-start justify-between gap-4">
                        <div>
                            ...
                            <p className="mt-1 max-w-2xl text-sm text-(--ink-muted)">
                                Relationship view showing how work load exchanges between teams,
                                repos, or work types. Complements the Sankey lifecycle view.
                            </p>
                        </div>
                        <span className="text-xs uppercase tracking-[0.2em] text-(--ink-muted)">
                            Exchange
