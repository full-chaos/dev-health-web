  ...
  return (
    ...
    >
      <div>
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, retention_days: parseInt(e.target.value) || 90 })
                    }
                    className="w-full rounded-lg border border-(--card-stroke) bg-(--card-70) px-3 py-2 text-sm focus:border-(--accent) focus:outline-none"
                  />
                </div>
        ...
        {loading ? (
          <div className="py-12 text-center text-(--ink-muted)">Loading retention policies...</div>
        ) : (
          <>
              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {policies.length === 0 ? (
                    ...
                    policies.map((policy) => (
                      <tr key={policy.id} className="border-b border-(--card-stroke) last:border-0">
                        <td className="px-4 py-3 font-mono text-xs">{policy.resource_type}</td>
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex flex-wrap items-center justify-end gap-2">
                            ...
                            >
                              {deletingId === policy.id ? "Confirm?" : "Delete"}
                            </button>
                          </div>
                        </td>
                      </tr>
