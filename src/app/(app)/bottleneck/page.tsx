            ...
            <div className="flex w-full flex-col gap-6 px-6 pb-16 pt-10 md:flex-row">
                ...
                <main className="flex min-w-0 flex-1 flex-col gap-8">
                    ...
                    <p className="-mt-2 text-xs text-(--ink-muted)">
                        WIP Saturation is indexed to a baseline of 100% (work in progress matched to
                        typical throughput). Readings above 100% mean more work is open than the
                        team usually clears in the window &mdash; e.g. 950% reads as ~9.5&times; the
                        baseline, not a data error. Sustained readings far above 100% point to
                        over-commitment, and the metric is intentionally uncapped so that severity
                        stays visible.
                    </p>
