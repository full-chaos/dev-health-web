...
const FEATURES: FeatureConfig[] = [
    {
        ...
        description:
            "Measure throughput and cycle time to keep the team unblocked and delivering consistently.",
        href: "/team-flow",
        icon: (
            <svg
    ...
    },
    {
        ...
        description:
            "Spot WIP saturation and review latency before they turn into major coordination debt.",
        href: "/bottleneck",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
        ...
        description:
            "Single-person views are strictly for private reflection, not peer ranking or surveillance.",
        href: "/people",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
        ...
        description:
            "Intervene early on burnout signals like after-hours work and weekend commit patterns.",
        href: "/cognitive-load",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
        ...
        description:
            "Manager coaching playbooks generated from actual investment data to support strategic conversations.",
        href: "/opportunities",
        icon: (
            <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <section className="mx-auto max-w-7xl px-6 pb-20 pt-16 sm:pt-24">
                <div className="mx-auto max-w-3xl text-center">
                    ...
                    <p className="mx-auto mt-6 max-w-2xl text-lg text-(--ink-muted)">
                        Gain deep visibility into team flow and bottlenecks. Equip yourself with
                        data to unblock your engineers, protect their focus, and advocate for
                        sustainable work without resorting to leaderboards.
                    </p>
