      ...
      <section className="mx-auto max-w-7xl px-6 pb-20 pt-16 sm:pt-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-(--ink-muted)">
            Gain deep visibility into team flow and bottlenecks. Equip yourself with data to unblock
            your engineers, protect their focus, and advocate for sustainable work without resorting
            to leaderboards.
          </p>
