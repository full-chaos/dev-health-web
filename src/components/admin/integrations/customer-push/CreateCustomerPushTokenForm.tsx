...
export function CreateCustomerPushTokenForm({
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        startTransition(async () => {
            // No source_id in the body — the backend derives it from the
            // POST /customer-push/sources/{sourceId}/tokens URL path
            // (verified: IngestTokenCreate has only name/scopes/expires_at).
    ...
    return (
        <form onSubmit={handleSubmit} className="max-w-xl space-y-6">
            ...
            <div className="flex items-center gap-3">
                ...
                >
                    {isPending ? "Creating..." : CTA_LABELS.createCredential}
                </button>
                <a
