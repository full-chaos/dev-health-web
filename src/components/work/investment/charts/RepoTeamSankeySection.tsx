	...
	return (
		<div className="rounded-3xl border border-(--card-stroke) bg-card p-5">
			...
			<div className="mb-4 mt-2 border-l-2 border-(--card-stroke) py-1 pl-3 text-xs leading-relaxed text-(--ink-muted)">
				This view uses repo-to-team mapping when available. Missing repo
				associations flow through an unassigned repo node.
			</div>
			<div className="mt-0">
				{isRepoTeamLoading ? (
					<p className="text-sm text-(--ink-muted)">
						Loading destination view...
					</p>
