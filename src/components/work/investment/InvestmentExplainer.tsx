                ...
                <div className="mt-4 space-y-4">
                    {mixExplanation.data?.status === "llm_unavailable" ? (
                        <p className="text-sm text-(--ink-muted)">
                            Investment distribution uses metadata-based categorization. Connect an
                            LLM provider in settings to enable AI-generated explanations.
                        </p>
                        ...
                        <>
                            ...
                            {(mixExplanation.data.top_findings?.length ?? 0) > 0 && (
                                <div className="space-y-2">
                                    ...
                                    <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                                        {mixExplanation.data.top_findings
                                            .slice(0, 3)
                                            .map((finding) => (
                                                <div
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {mixExplanation.data.confidence?.quality_mean != null && (
                                        <span className="text-xs text-(--ink-muted)">
                                            ...
                                            %
                                            {mixExplanation.data.confidence.quality_stddev !=
                                                null &&
                                                ` +- ${formatNumber(
                                                    mixExplanation.data.confidence.quality_stddev *
                                                        100,
                            ...
                            {mixExplanation.data.status &&
                                mixExplanation.data.status !== "valid" && (
