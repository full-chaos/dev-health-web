			...
			<div className="flex flex-wrap items-start justify-between gap-4">
				<div>
					...
					<p className="mt-2 max-w-2xl text-sm text-(--ink-muted)">
						Connected issues, PRs, reviews, commits, deployments, and incidents
						with the relationship evidence that created each edge.
					</p>
				</div>
									...
									{edges.map((edge) => {
										const linkedType =
											edge.sourceType === type
												...
												: edge.targetType;
										const linkedId =
											edge.sourceType === type ? edge.sourceId : edge.targetId;
										return (
											<article
												key={edge.edgeId}
