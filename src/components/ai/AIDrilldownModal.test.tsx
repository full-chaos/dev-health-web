...
describe("AIDrilldownModal", () => {
  ...
  it("renders loading state while fetching", () => {
    ...
    render(<AIDrilldownModal metric="Pickup latency" filter={filter} onClose={() => undefined} />);
  ...
  it("renders error banner when AI-attributed PRs query fails", () => {
    ...
    render(<AIDrilldownModal metric="Incident rate" filter={filter} onClose={() => undefined} />);

    expect(screen.getByTestId("ai-drilldown-error")).toHaveTextContent(/ClickHouse unavailable/);
  });
