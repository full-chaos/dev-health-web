...
import {
	CockpitEmptyState,
	type CockpitEmptyStateVariant,
} from "./CockpitEmptyState";
...
describe("CockpitEmptyState", () => {
	it.each(
		Object.entries(VARIANT_TITLES) as [CockpitEmptyStateVariant, string][],
	)("renders Phase-1 customer-safe copy for the %s variant", (variant, title) => {
