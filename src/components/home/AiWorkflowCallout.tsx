 ...
 * direct link.
 */
export function AiWorkflowCallout({ filters, activeRole, prominent }: AiWorkflowCalloutProps) {
    if (!prominent) {
        return (
            <div
            ...
            <div className="flex flex-col gap-6">
                <div>
                    ...
                    <p className="mt-3 text-sm leading-6 text-(--ink-muted)">
                        See whether AI-assisted work is improving delivery or shifting cost into
                        review, rework, and risk.
                    </p>
